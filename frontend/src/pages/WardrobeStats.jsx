...
const MATERIAL_COLOR_MAP = {
  // New specific slugs
  bleached_cotton: '#FFFFF0',
  ecru_linen: '#D2B48C',
  jute_burlap: '#654321',
  champagne_satin: '#FFDEAD',
  brocade_gold: '#D4AF37',
  liquid_copper: '#8B4513',
  cashmere_down: '#E6E6FA',
  amethyst_chiffon: '#9370DB',
  velvet_maroon: '#4A001F',
  vachetta_cowhide: '#FFDAB9',
  saddle_tan: '#CD853F',
  cordovan_oxblood: '#800020',
  chambray_light: '#B0E0E6',
  denim_indigo: '#1E90FF',
  ballistic_nylon_black: '#1A2530',
  tyvek_mesh: '#E0FFF0',
  tarp_vinyl: '#00FF7F',
  olive_drab_ripstop: '#355E3B',

  // Common/fallback slugs mapping to the new colors
  cotton: '#FFFFF0',
  linen: '#D2B48C',
  jute: '#654321',
  burlap: '#654321',
