  ...
  toast.error(
    <div className="flex flex-col gap-2 text-start p-1">
      <div className="flex items-center gap-2 font-semibold text-sm">
        ...
        <span>Gemini AI Key or Plan Required</span>
      </div>
      <p className="text-xs text-muted-foreground leading-relaxed">
        To use DressApp's Gemini AI features (AI Stylist, GarmentVision, Image Editing, Reconstruction), please configure your Gemini API Key in your Profile settings.
      </p>
      <button
        onClick={() => {
