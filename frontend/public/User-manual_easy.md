...
- **3. Details (Name & Phone)**: This lets DressApp know who you are so it can greet you by name. The app uses your name in greeting alerts and emails. Your phone number is used to send push alerts. Configure your phone number under the CONTACT section.
- **4. Body & Measurements (Your Sizes)**: It helps DressApp find clothes that fit you. If you are new, fill in your Height, Weight, Waist, and Foot Length, and the app will predict the remaining 6 measurements for you. If you return to edit, any change to the basic 4 instantly recalculates the rest.
