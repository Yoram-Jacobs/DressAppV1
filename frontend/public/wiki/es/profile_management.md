# Perfil, tamaño y configuración

Ajuste sus medidas, restricciones de modestia y credenciales de IA.

## Descripción general
La sección Perfil mantiene actualizado su contexto de estilo, administrando parámetros del cuerpo, reglas de estilo, claves personalizadas y configuraciones de región local.
...
- Las alertas push de campaña requieren permisos de notificación del navegador. Si está bloqueado, solo recibirá notificaciones de la campaña por correo electrónico.