...
# Browser UI/UX Crawler

This skill automates deep-crawling of the DressApp frontend UI, profiling performance metrics, verifying language/i18n state transitions across all 12 locales, and capturing visual render snapshots.
