          ...
          return {
            ...
            item: item
              ? {
                  ...
                  brand: item.brand,
                  image_url: item.reconstructed_image_url || item.reconstruct_image_url || item.clean_image_url || item.thumbnail_data_url || item.image_url || item.segmented_image_url,
                }
              : null,
          };
        }
          ...
          <View style={[styles.modalContent, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <FlatList
              ...
              renderItem={({ item }: { item: any }) => {
                ...
                const img = item.reconstructed_image_url || item.reconstruct_image_url || item.clean_image_url || item.thumbnail_data_url || item.image_url || item.segmented_image_url;
                return (
                  <TouchableOpacity
