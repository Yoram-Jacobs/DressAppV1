...
const INTENT_OPTIONS = [
  ...
  },
  {
    value: "for_sale",
    icon: HandCoins,
    tone: "bg-amber-900 text-white border-amber-900",
  },
  {
    value: "donate",
    icon: Gift,
    tone: "bg-emerald-900 text-white border-emerald-900",
  },
  {
    value: "swap",
    icon: Repeat,
    tone: "bg-sky-900 text-white border-sky-900",
  },
  {
    value: "rent",
    icon: Calendar,
    tone: "bg-indigo-900 text-white border-indigo-900",
  },
];
              ...
              >
                ...
                >
                  ...
                  {isActive && step.key === "refinement" && total > 0 && (
                    <span className="text-text-brand font-normal normal-case tracking-normal">
                      {" "}
                      ({scanned}/{total})
                    </span>
                  )}
  ...
  const handleSelectorTouchStart = (e, id, mode) => {
    ...
    if (e.touches.length === 2) {
      ...
      setDragState({
        ...
        startLeft: selector.x,
        startTop: selector.y,
        initialDx: Math.abs(t1.clientX - t2.clientX) || 1,
        initialDy: Math.abs(t1.clientY - t2.clientY) || 1,
        ...
        <div className="" data-testid="add-item-page">
          ...
          {bgBatch ? (
            ...
            >
              ...
              <div className="text-sm text-text-brand mt-1 max-w-md">
              ...
              <div className="mt-5 w-full max-w-md">
                <div className="flex items-center justify-between text-xs text-text-brand mb-1">
                ...
                >
                  {!(
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-1.5 p-1 bg-primary-shadow rounded-full mb-6 max-w-sm w-full border border-border/40">
                        <button
                          ...
                          className={`flex-1 py-2 px-3 rounded-lg text-[12px] font-bold transition-all duration-200 ${importMode === "text"
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 px-3 rounded-lg text-[12px] font-bold transition-all duration-200 ${importMode === "file"
                            ? "bg-white text-primary-brand shadow-sm"
                            : "text-text-brand hover:text-primary-brand"
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`flex-1 py-2 px-3 rounded-lg text-[12px] font-bold transition-all duration-200 ${importMode === "url"
                            ? "bg-white text-primary-brand shadow-sm"
                            : "text-text-brand hover:text-primary-brand"
                            }`}
                        >
                    ...
                    <div className="w-full flex flex-col items-center">
                      <div className="text-sm font-bold mb-4 flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className="text-text-brand hover:text-dark-brand hover:bg-transparent flex items-center gap-1"
                      ...
                      {/* Selector Container */}
                      <div className="max-w-sm w-full border border-border rounded-[12px] mb-[20px]">
                        <div className="relative aspect-[4/3] selector-container select-none">
                          {/* The Preview Content */}
                          {receiptText ? (
                            // Text block (either pasted, text file, or OCR'd text)
                            <div className="w-full h-auto rounded-[12px] p-4 text-text-brand bg-primary-shadow font-semibold text-[12px] text-left whitespace-pre-wrap leading-normal pointer-events-none">
                              {receiptText}
                            </div>
                          ) : importFile &&
                            importFile.type.startsWith("image/") &&
                          ...
                          >
                            ...
                            <div className="relative w-20 h-24 bg-secondary/10 rounded-xl overflow-hidden shrink-0 border border-border/40 flex items-center justify-center self-center">
                              {item.base64Image ? (
                                ...
                                <div className="flex flex-col items-center justify-center p-2 text-center text-[10px] text-text-brand/60">
                            ...
                            <div className="flex-1 min-w-0 grid grid-cols-2 gap-3 pt-6 md:pt-0">
                              <div className="col-span-2">
                                <Label className="text-[10px] text-text-brand uppercase tracking-wider font-semibold">
                              ...
                              {item.closetItem ? (
                                <div className="flex flex-col items-center gap-1 mt-0.5">
                                  ...
                                  <button
                                    ...
                                    className="text-[8px] text-text-brand hover:text-foreground border-0 bg-transparent cursor-pointer underline underline-offset-1"
                                  >
                            ...
                            {closetItemsFiltered.map((it) => (
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <div className="text-[10px] text-text-brand truncate">
                                    {it.brand ||
                          ...
                          <div className="w-full aspect-[3/4] bg-secondary/20 relative overflow-hidden">
                            {closetItemDetailPane.original_image_url ||
                              ...
                              <div className="w-full h-full flex items-center justify-center">
                                <Shirt className="h-20 w-20 text-text-brand/30" />
                              </div>
                            )}
                            {/* Gradient overlay */}
                          ...
                          <div className="px-5 pb-5 pt-3 space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {closetItemDetailPane.brand && (
                                <span className="text-[11px] bg-secondary px-2 py-0.5 rounded-full text-text-brand font-medium">
                                  {closetItemDetailPane.brand}
                                </span>
                              )}
...
function ItemCard({
  ...
  return (
    <Card
      className={`rounded-[12px] shadow-sm overflow-hidden ${saved ? "opacity-75" : ""}`}
          ...
          <div className="relative">
            ...
            {card.polishStatus === "pending" && (
              <div className="absolute bottom-2 start-2">
                <Badge
                  variant="secondary"
                  className="bg-background/90 text-[10px] backdrop-blur border-border/60 flex items-center gap-1 text-text-brand"
                >
              ...
              <div className="space-y-4" data-testid="quick-confirm-fields">
                ...
                <div className="space-y-1">
                  <Label
                    ...
                    className="caps-label text-text-brand"
                  >
              ...
              <>
                ...
                <div className="">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 bg-yellow-shadow mb-5 rounded-[8px] transition-colors text-start focus:outline-none"
                  >
                    ...
                    {sections.basic ? (
                      <ChevronUp className="h-4 w-4 text-dark-brand" />
                    ) : (
                      <ChevronDown className="h-4 w-4 text-dark-brand" />
                    )}
                  </button>
                ...
                <div className="">
                  ...
                  >
                    ...
                    {sections.styling ? (
                      <ChevronUp className="h-4 w-4 text-text-brand" />
                    ) : (
                      <ChevronDown className="h-4 w-4 text-text-brand" />
                    )}
                  </button>
...
function NameCaption({ idPrefix, fields, onChange, disabled }) {
  ...
  return (
    <div className="">
      <div>
        <Label htmlFor={`${idPrefix}-name`}>{t("addItem.itemName")}</Label>
        <Input
          id={`${idPrefix}-name`}
          value={fields.name || ""}
          onChange={(e) => onChange({ name: e.target.value })}
      ...
      <div>
        <Label htmlFor={`${idPrefix}-caption`}>{t("addItem.caption")}</Label>
        <Textarea
          id={`${idPrefix}-caption`}
...
function IntentSelector({ idPrefix, fields, onChange, disabled }) {
  ...
  return (
    <div className="rounded-[12px] border border-border p-3 bg-primary-shadow !mb-[20px]">
      <div className="flex items-center justify-between mb-2">
        <Label className="flex items-center gap-1 mb-0">
          <Tag className="!h-4 !w-4 text-primary-brand" /> {t("addItem.marketplaceIntent")}
        </Label>
        <Badge variant="outline" className="text-[10px] bg-white text-dark-brand border-border">
      ...
      {showPriceInput && (
        ...
        >
          ...
          <div className="text-[10px] text-text-brand self-end">
            <div className="flex justify-between">
              <span>{t("addItem.stripeFee")}</span>
              <span className="font-bold">{fmtCents(stripeFee)}</span>
            </div>
            <div className="flex justify-between">
              <span>{t("transactions.platform7")}</span>
              <span className="font-bold">{fmtCents(platformFee)}</span>
            </div>
            <div className="flex justify-between font-medium text-foreground">
              <span>{t("addItem.youReceive")}</span>
              <span className="font-bold">{fmtCents(sellerNet)}</span>
            </div>
          </div>
        </div>
      )}
...
function SeasonPicker({ idPrefix, fields, onChange, disabled }) {
  ...
  return (
    <div>
      <Label id={labelId}>{t("addItem.season")}</Label>
      <div
        ...
        {SEASON_OPTIONS.map((s) => {
          ...
          return (
            <button
              ...
              className={`rounded-full px-3 py-1 text-[12px] font-bold border ${on
                ? "bg-primary-shadow text-primary-brand border-border"
                : "bg-white border-border text-text-brand"
                }`}
            >
              {labelForSeason(s, t)}
            </button>
      ...
      <div className="mt-1" data-testid="add-item-tags">
        ...
        <div className="flex items-center gap-1 mt-1.5">
          <Input
            ...
            disabled={disabled}
            className="rounded-full mb-0 h-9 w-50"
        ...
        <div className="flex items-center gap-3 my-2">
          {dup?.thumbnail_data_url ? (
            <div className="flex-1 flex flex-col items-center gap-1">
              ...
              />
              <span className="caps-label text-text-brand">
