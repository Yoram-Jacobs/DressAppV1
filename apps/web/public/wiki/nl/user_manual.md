...
- **Probleem**: Kledinginvoer geblokkeerd. U heeft de basislimiet van 50 items bereikt (of tot 150 items door verwijzingsbonussen).
- **Oplossing**: Ga naar de **tarievenpagina** (`/pricing`) en neem een abonnement op de Manager- of Professional-plan, of deel uw verwijzingslink om +10 plaatsen per registratie te krijgen (tot maximaal 150 items).
