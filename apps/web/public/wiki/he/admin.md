...
- **אינטגרציית Google OAuth**: תהליך ההתחברות בסביבת הייצור מתבצע דרך Google OAuth‏ (`dressappdeveloper@gmail.com`), תוך ביטול קיצורי דרך מקומיים קבועים בקוד לטובת אבטחה מוקשחת.
