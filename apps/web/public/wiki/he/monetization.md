...
* כדי למנוע הפרעות בשירות, על משתמשי מסלול Free לשדרג למסלול המנוי Manager או Professional.
...
* **תוכניות בתשלום**: משתמשים במסלולי Manager או Professional פעילים מקבלים פעולות AI יומיות ללא הגבלה ואינם כפופים למדידת נקודות, פקיעת תוקף או בדיקות עדיפות ניכוי.
...
3. **אימות Webhook וחיוב קמפיינים**:
   ...
   - עם זאת, `atzmai_topups` נותר פעיל עבור קליטה ואימות של **תשלומי קמפיין יומיים (עמלה של $1 ליום)**.
