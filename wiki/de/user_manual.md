...
- **Problem**: Ingestion blockiert. Sie haben das Basislimit von 50 Artikeln erreicht (oder bis zu 150 Artikel durch Empfehlungsboni).
- **Lösung**: Gehen Sie zur **Preisseite** (`/pricing`) und abonnieren Sie den Manager- oder Professional-Plan, oder teilen Sie Ihren Empfehlungslink, um +10 Plätze pro Registrierung zu erhalten (bis zu maximal 150 Artikel).
