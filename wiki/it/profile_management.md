...
- **Abbonamento e Limiti dell'Armadio**:
  ...
  - **Programma per il Gruppo di Tester**: Gli indirizzi email dei tester approvati (`maystarboard@gmail.com`, `lokoprod@gmail.com`, `dressapdeveloper@gmail.com`) beneficiano gratuitamente del **piano Professional** senza costi di sottoscrizione.
...
- **Pannello per Sviluppatori**: Sezione diagnostica per i test dell'ambiente. Autenticata con Google OAuth (`dressapdeveloper@gmail.com`).
...
## Limitazioni
- Lo spazio disponibile nel piano Free Tier è limitato a 50 capi base, salvo ampliamento con i bonus di invito (+10 posti per invitato fino a un massimo di 150 capi) o passaggio ai piani Manager o Professional.
