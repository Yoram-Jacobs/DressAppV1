...
2. **Mensaje "Capacidad del armario alcanzada"**:
   - Las cuentas gratuitas almacenan hasta **1,000 prendas** como base.
   - Puedes invitar amigos para obtener **+10 espacios adicionales** por cada registro (hasta un máximo de 1,000 prendas), eliminar ropa que no uses o pulsar en **Mejorar a Pro** ($4.99/mes) para almacenamiento ilimitado.
