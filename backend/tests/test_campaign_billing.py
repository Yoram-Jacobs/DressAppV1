...
async def test_bill_ended_campaign():
    ...
    with patch("app.services.email_service.fetch_invoice_and_receipt_attachments", return_value=[]), \
        ...
        assert update_args["$set"]["billing.total_fee_cents"] == 400
        ...
        assert email_kwargs["amount_cents"] == 400
